...
int main(void)
{
    ...
    reg_map_dynamic<std::uint32_t, std::uint32_t, bit32_type>::bits(ahb1enr).b0 = 1U;
    
    /* Set GPIOA5 to output */
    reg_map_dynamic<std::uint32_t, std::uint32_t, bit32_type>::bits(gpioa_m).b10 = 1U;
    reg_map_dynamic<std::uint32_t, std::uint32_t, bit32_type>::bits(gpioa_m).b11 = 0U;

    while(1)
    {
        /* toggle GPIOA5 */
        reg_map_dynamic<std::uint32_t, std::uint32_t, bit32_type>::bits(gpioa_o).b5 ^= 1U;
